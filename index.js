   ...
   */
    var rmp = function(options) {
        ...
        priv.getSearchUrl = function(options) {
            ...
            return "http://www.ratemyprofessors.com/search.jsp?query=" + encodeURIComponent(priv.config.location) + encodeURIComponent(" ") + encodeURIComponent(query);
        };
            ...
            var scrape = function(html, callback) {
                ...
                try {
                    ...
                    if (typeof $(priv.selectors.chili, page).attr("src") === "undefined") {
                        throw new Error("Chili undefined. This is a rare error that " + "happens for a few professors. Please help us out by providing " + "the query you used with rmp-api.");
                    }
                    professor = {
                        url: url,
                    ...
                    professor = {
                        ...
                        university: $(priv.selectors.university, page).text().trim(),
                        chili: "cold",
                        // fallback to cold - scraping this causes a strange error
                        tags: tags,
                        comments: comments
                    };
                }
        ...
        priv.matches = function(_name1, _name2, exactOnly) {
            ...
            if (name1.full === name2.full) {
                ...
                if (name1.full.includes(name2.first) && name1.full.includes(name2.last)) {
                    return true;
                } else if (name2.full.includes(name1.first) && name2.full.includes(name1.last)) {
                    return true;
                } else {
                    return false;
                }

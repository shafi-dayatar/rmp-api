...
(function() {
    ...
    var rmp = function(options) {
        ...
        priv.getSearchUrl = function(query) {
            return "http://www.ratemyprofessors.com/search.jsp?queryBy=teacherName&schoolName=" + encodeURIComponent(query.university) + encodeURIComponent(" ") + encodeURIComponent(query.campus) + "&queryoption=HEADER&query=" + encodeURIComponent(query.name) + "&facetSearch=true";
        };
